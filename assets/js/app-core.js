  ...
  const APP_CHANGELOG=[
    {number:144,title:"Library navigation cleanup",date:"2026-09-22",commit:"6d53fec2d9c373556c2fff727e60248c892f393b",changes:["Removed History and Watchlist from the bottom navigation.","Kept Library, Search and Settings as the bottom navigation options.","Retained the underlying library history and upcoming-title functionality so existing data and behavior are not deleted."]},{commit:"f2b07bbf6c593374ffb52856491b232f1f46304e",title:"Reminder backend deployment (PR #1)",date:"2026-09-17",changes:["Added reproducible database setup for background reminders.","Preserved existing subscriptions and configuration.","Deployed and verified the reminder migration."]},
